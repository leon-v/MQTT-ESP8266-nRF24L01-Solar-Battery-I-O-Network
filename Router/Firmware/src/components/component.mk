...
ESP8266_RTOS_SDK/components/lwip/lwip/src/apps/httpd/httpd.o: CFLAGS += -DLWIP_HTTPD_SSI=1
ESP8266_RTOS_SDK/components/lwip/lwip/src/apps/httpd/httpd.o: CFLAGS += -DLWIP_HTTPD_DYNAMIC_HEADERS=1
